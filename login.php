...
if (isset($_POST['email']) && isset($_POST['password'])) {
    ...
    $query = "SELECT * FROM reg WHERE email = '$e' AND password = '$p'";
    $result = $conn->query($query);

    if ($result->num_rows > 0) {
        $_SESSION['logged'] = $e;
        echo "<script>alert('Login success');window.location.replace('home.php');</script>";
    } else {
        echo "<script>alert('Invalid details');window.location.replace('login.php');</script>";
    }
} 
                    ...
                    <div class="appointment-form h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn" data-wow-delay="0.6s">
                        ...
                        <form action="" method="POST">
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <input type="password" class="form-control bg-light border-0" placeholder="Password" name="password" style="height: 55px;" required>
                                </div>
                                <div class="col-12">
                                    <button class="btn btn-dark w-100 py-3" type="submit">Login here</button>
                                </div>
                            </div>
                        </form>
