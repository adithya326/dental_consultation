    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-5 py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="bookdetais.php" class="nav-item nav-link">Book details</a>
...
<div class="modal fade" id="searchModal" tabindex="-1" aria-labelledby="searchModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <a href="login.php" class="nav-item nav-link" onclick="logout(); return false;">Logout</a>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <a href="compailnt.html" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Feedback</a>
                        </div>
                    </div>
                </div>
