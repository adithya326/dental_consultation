                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-3 animated slideInDown">Welcome, <?php echo $email;?></h5>
...
<form action="editprofile.php" method="POST">
                            <div class="row g-3">
                                <div class="col-12 col-sm-6">
                                    <input type="text" class="form-control bg-light border-0" placeholder="Your Name" name="name" style="height: 55px;"  value="<?php echo $name;?>" required>
                                </div>
                                
                                <div class="col-12 col-sm-6">
                                    <input type="email" class="form-control bg-light border-0" placeholder="Your Email" name="email"  readonly style="height: 55px;" value="<?php echo $email;?>" required>
                                </div>

                                <div class="col-12 col-sm-6">
                                <input type="tel" class="form-control bg-light border-0" placeholder="number" name="number" style="height: 55px;" value="<?php echo $number ; ?>" required>
                              
                                </div>
                                <div class="col-12 col-sm-6">
                                <input type="text" class="form-control bg-light border-0" placeholder="gender" name="gender" style="height: 55px;" value="<?php echo $gender;?>" required>
                              
                                </div>
                                <div class="col-12 col-sm-6">
                                    <input type="age" class="form-control bg-light border-0" placeholder="Your age" name="age"  style="height: 55px;" value="<?php echo $age;?>" required>
                                </div>

                                
                                <div class="col-12 col-sm-6">
                                    <input type="text" class="form-control bg-light border-0" placeholder="place" name="place" style="height: 55px;"  value="<?php echo $place;?>"required>
                                </div>
                                <div class="col-12 col-sm-6">
                                <input type="text" class="form-control bg-light border-0" placeholder="password" name="password" style="height: 55px;" value="<?php echo $password;?>" required>
                              
                                </div>
                                <div class="col-12">
                                    <button class="btn btn-dark w-100 py-3" type="submit">Edit Profile</button>
</div>
</form>
                    ...
                    <div class="appointment-form h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn" data-wow-delay="0.6s">
                        ...
                        <form>
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <input type="location" class="form-control bg-light border-0" placeholder="choose your location" style="height: 55px;">
                                </div>
                                <div class="col-12">
